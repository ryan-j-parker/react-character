...
export default function Editor({ head, setHead, tops, setTops, bottoms, setBottoms, headCounter, setHeadCounter, topsCounter, setTopsCounter, bottomsCounter, setBottomsCounter }) {
  return (
